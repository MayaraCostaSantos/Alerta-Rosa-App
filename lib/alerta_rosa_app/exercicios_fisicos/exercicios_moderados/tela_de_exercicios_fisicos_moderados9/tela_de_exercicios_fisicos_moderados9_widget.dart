...
class TelaDeExerciciosFisicosModerados9Widget extends StatefulWidget {
  const TelaDeExerciciosFisicosModerados9Widget({super.key});

  @override
  State<TelaDeExerciciosFisicosModerados9Widget> createState() =>
      _TelaDeExerciciosFisicosModerados9WidgetState();
}

class _TelaDeExerciciosFisicosModerados9WidgetState
    extends State<TelaDeExerciciosFisicosModerados9Widget> {
  late TelaDeExerciciosFisicosModerados9Model _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => TelaDeExerciciosFisicosModerados9Model());
              ...
              children: [
                ...
                const Align(
                  ...
                  child: FlutterFlowVideoPlayer(
                    path:
                        'https://firebasestorage.googleapis.com/v0/b/alertarosa-c180e.appspot.com/o/WhatsApp_Video_2024-05-03_at_15.38.59_(1).mp4?alt=media&token=556d0b8d-29fc-4f8e-abab-0e1b38a55e0b',
