...
import 'tela_de_exercicios_fisicos_moderados4_model.dart';
export 'tela_de_exercicios_fisicos_moderados4_model.dart';

class TelaDeExerciciosFisicosModerados4Widget extends StatefulWidget {
  const TelaDeExerciciosFisicosModerados4Widget({super.key});

  @override
  State<TelaDeExerciciosFisicosModerados4Widget> createState() =>
      _TelaDeExerciciosFisicosModerados4WidgetState();
}

class _TelaDeExerciciosFisicosModerados4WidgetState
    extends State<TelaDeExerciciosFisicosModerados4Widget> {
  late TelaDeExerciciosFisicosModerados4Model _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => TelaDeExerciciosFisicosModerados4Model());
            ...
            child: InkWell(
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    alignment: const AlignmentDirectional(0.19, -0.74),
                    child: Text(
                  ...
                  Align(
                    alignment: const AlignmentDirectional(0.42, -0.46),
                    child: Padding(
                      padding:
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-1.15, 0.83),
                    child: Padding(
                      padding:
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-1.14, 0.89),
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(20.0, 5.0, 0.0, 0.0),
                      child: FFButtonWidget(
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-1.14, 0.94),
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(20.0, 5.0, 0.0, 0.0),
                      child: FFButtonWidget(
                  ...
                  const Align(
                    alignment: AlignmentDirectional(-1.01, 0.78),
                    child: Icon(
                  ...
                  Align(
                    alignment: const AlignmentDirectional(0.37, -0.88),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
                  ...
                  const Align(
                    alignment: AlignmentDirectional(-0.07, -0.16),
