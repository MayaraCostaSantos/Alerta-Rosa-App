          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(1.12, -0.68),
                  child: Padding(
                    padding:
                ...
                const Align(
                  alignment: AlignmentDirectional(-0.9, 0.78),
                  child: Icon(
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.84, 0.32),
                  child: Text(
                    'Passo a passo:',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Roboto',
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(100.0, 0.0, 30.0, 0.0),
                    child: Text(
                      '1.Aquecimento:',
                      textAlign: TextAlign.start,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.06, 0.62),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.05, 0.69),
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 0.0),
                    child: FFButtonWidget(
