          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: AlignmentDirectional(1.12, -0.68),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: AlignmentDirectional(-0.84, 0.32),
                  child: Text(
                    'Passo a passo:',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Roboto',
                ...
                Align(
                  alignment: AlignmentDirectional(-0.61, -0.42),
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(100.0, 0.0, 30.0, 0.0),
                    child: Text(
                      '1.Aquecimento:',
                      textAlign: TextAlign.start,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
