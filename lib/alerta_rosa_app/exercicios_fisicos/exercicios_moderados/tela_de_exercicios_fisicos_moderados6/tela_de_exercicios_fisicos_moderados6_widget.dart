          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(0.17, -0.73),
                  child: Text(
                ...
                Align(
                  alignment: const AlignmentDirectional(0.19, -0.47),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.04, 0.92),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.12, 0.59),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.12, 0.64),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.86, 0.22),
                  child: Text(
                    'Passo a passo',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Roboto',
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.48, -0.87),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
