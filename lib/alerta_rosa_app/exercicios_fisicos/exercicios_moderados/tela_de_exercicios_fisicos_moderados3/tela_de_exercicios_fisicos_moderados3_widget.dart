          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(0.08, 0.96),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-1.09, 0.85),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(-1.08, 0.91),
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 5.0, 0.0, 0.0),
                    child: FFButtonWidget(
                ...
                Align(
                  alignment: const AlignmentDirectional(-1.08, 0.96),
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 5.0, 0.0, 0.0),
                    child: FFButtonWidget(
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.84, 0.22),
                  child: Text(
                    'Passo a passo:',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Roboto',
