...
import 'tela_de_exercicios_intensos6_model.dart';
export 'tela_de_exercicios_intensos6_model.dart';

class TelaDeExerciciosIntensos6Widget extends StatefulWidget {
  const TelaDeExerciciosIntensos6Widget({super.key});

  @override
  State<TelaDeExerciciosIntensos6Widget> createState() =>
      _TelaDeExerciciosIntensos6WidgetState();
}

class _TelaDeExerciciosIntensos6WidgetState
    extends State<TelaDeExerciciosIntensos6Widget> {
  late TelaDeExerciciosIntensos6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaDeExerciciosIntensos6Model());
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(0.11, -0.46),
                  child: Padding(
                    padding:
                ...
                Align(
                  alignment: const AlignmentDirectional(0.49, -0.84),
                  child: InkWell(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'A praticante deverá ficar deitada em decúbito dorsal(com as costas voltadas para baixo) em uma superfície plana horizontal e preferencialmente alcochoada, elevando seus braços a frente segurando uma carga externa (saco de arroz/feijão/garrafa pet) e flexionar os cotovelos controlando a descida da carga até a testa e em seguinda voltando para a posição inicial. Prestar atenção no movimento para que haja de fato apenas o movimento de extensão e flexão dos cotovelos(movimento apenas do antebraço e braço fixo na posição vertical), conforme vídeo. Deve-se fazer 1 série de 15 a 20 repetições nas duas primeiras semanas e a partir da terceira semana, 3 séries de 10 a 15 repetições. respeite a pausa entre as séries.',
                      textAlign: TextAlign.justify,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Roboto',
                            fontSize: 12.0,
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.46, -0.84),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                ...
                const Align(
                  ...
                  child: FlutterFlowVideoPlayer(
                    path:
                        'https://firebasestorage.googleapis.com/v0/b/alertarosa-c180e.appspot.com/o/WhatsApp_Video_2024-05-03_at_15.14.08.mp4?alt=media&token=c787761b-3265-4eaf-bac6-85add2d419be',
