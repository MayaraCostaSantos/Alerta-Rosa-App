          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(0.13, -0.46),
                  child: Padding(
                    padding:
                ...
                const Align(
                  ...
                  child: FlutterFlowVideoPlayer(
                    path:
                        'https://firebasestorage.googleapis.com/v0/b/alertarosa-c180e.appspot.com/o/WhatsApp_Video_2024-05-03_at_14.50.06.mp4?alt=media&token=a002ac95-8801-458a-9b8a-55aa2233c330',
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.37, -0.85),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
