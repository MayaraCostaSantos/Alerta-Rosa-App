...
import 'tela_de_exercicios_intensos5_model.dart';
export 'tela_de_exercicios_intensos5_model.dart';

class TelaDeExerciciosIntensos5Widget extends StatefulWidget {
  const TelaDeExerciciosIntensos5Widget({super.key});

  @override
  State<TelaDeExerciciosIntensos5Widget> createState() =>
      _TelaDeExerciciosIntensos5WidgetState();
}

class _TelaDeExerciciosIntensos5WidgetState
    extends State<TelaDeExerciciosIntensos5Widget> {
  late TelaDeExerciciosIntensos5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaDeExerciciosIntensos5Model());
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: AlignmentDirectional(0.43, -0.84),
                  child: InkWell(
                ...
                Align(
                  alignment: AlignmentDirectional(-0.4, -0.84),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    hoverColor: Colors.transparent,
