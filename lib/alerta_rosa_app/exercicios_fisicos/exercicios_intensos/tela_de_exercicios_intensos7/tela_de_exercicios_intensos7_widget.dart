...
import 'tela_de_exercicios_intensos7_model.dart';
export 'tela_de_exercicios_intensos7_model.dart';

class TelaDeExerciciosIntensos7Widget extends StatefulWidget {
  const TelaDeExerciciosIntensos7Widget({super.key});

  @override
  State<TelaDeExerciciosIntensos7Widget> createState() =>
      _TelaDeExerciciosIntensos7WidgetState();
}

class _TelaDeExerciciosIntensos7WidgetState
    extends State<TelaDeExerciciosIntensos7Widget> {
  late TelaDeExerciciosIntensos7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaDeExerciciosIntensos7Model());
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: const AlignmentDirectional(0.22, -0.52),
                  child: Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 30.0, 0.0),
                    child: Text(
                      '7. Passada em progressão:',
                ...
                const Align(
                  ...
                  child: SizedBox(
                    ...
                    child: FlutterFlowVideoPlayer(
                      path: 'https://firebasestorage.googleapis.com/v0/b/alertarosa-c180e.appspot.com/o/WhatsApp%20Video%202024-05-03%20at%2015.49.59.mp4?alt=media&token=4a0cce07-5126-42b8-92e8-7ec3d8706db8',
                ...
                Align(
                  alignment: const AlignmentDirectional(-0.8, 0.12),
                  child: Text(
                    'Passo a passo:',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                      fontFamily: 'Montserrat',
                ...
                Align(
                  ...
                  child: SizedBox(
                    ...
                    child: Text(
                      'A praticante deverá ficar em pé e iniciará dando um passo a frente de aproximadamente 1 metro. Em seguida fará um movimento tô de descida do tronco (agachamento unipodal) fazendo com que o joelho da perna que ficou  trás chegue bem próximo ao chão, conforme vídeo.\nDeverão ser feitas 2 séries de 10 a 14 passos nas duas primeiras semanas e a partir da terceira semana 3 séries de 14 a 20 passos, respeitando o tempo de intervalo entre cada série.',
