...
class TelaSecrecaonomamiloWidget extends StatefulWidget {
  const TelaSecrecaonomamiloWidget({super.key});

  @override
  State<TelaSecrecaonomamiloWidget> createState() =>
      _TelaSecrecaonomamiloWidgetState();
}

class _TelaSecrecaonomamiloWidgetState
    extends State<TelaSecrecaonomamiloWidget> {
  late TelaSecrecaonomamiloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaSecrecaonomamiloModel());
  }
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      'assets/images/secrecao_no_mamilo.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
